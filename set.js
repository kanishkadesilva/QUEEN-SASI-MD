...
module.exports = { session: process.env.SESSION_ID || 'zokk',
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Kanishka De Silva",
    NUMERO_OWNER : process.env.OWNER_NUMBER || "94722477361",              
    AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "oui",
    AUTO_DOWNLOAD_STATUS: process.env.AUTO_DOWNLOAD_STATUS || 'non',
    BOT : process.env.BOT_NAME || 'QUEEN-SASI-MD',
    OPENAI_API_KEY : process.env.OPENAI_API_KEY || 'sk-proj-YfcNzdUKxlPr4yOkKYRQT3BlbkFJB0dbLsM9gWNTh52M3hAw',
    URL : process.env.BOT_MENU_LINKS || 'https://telegra.ph/file/3cd8de5d949bff74889e2.mp4',
