const { tlang, ringtone, cmd,fetchJson, sleep, botpic,ffmpeg, getBuffer, pinterest, prefix, Config } = require('../framework/zokou')
...
cmd({
       ...
       if(!isCreator) return citel.reply(tlang().owner);
        let buttons = [{
            ...
            let buttonMessage = {
                image: {
                    url: 'https://telegra.ph/file/3cd8de5d949bff74889e2.mp4',
                },
