    ...
    if (_0x163370 === "close") {
      ...
      if (_0x163370 === "open") {
        ...
        _0x1303d3.sendMessage(_0x5e1cbe, {
          'text': "*✅ QUEEN SASI-MD SUCCESS CONNECT YOUR WHATSAPP*"
        });
    ...
    try {
      ...
      switch (_0x44ccdd) {
        ...
        case 'alive':
          {
            if (!_0x1b3106) {
              return _0x33e5d9("*HI IM ALIVE NOW IM SASI-MD*");
            }
...
app.get('/', (_0x532ec5, _0x5351ff) => {
  _0x5351ff.send("📟 QUEEN SASI-MD Working successfully!");
});
